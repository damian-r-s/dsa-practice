...
# 1 - even
# 0 - odd
def ExchangeEvenNumberOfCoins(coins, n):
...
print(ExchangeEvenNumberOfCoins([1, 3, 5, 10], 10))    

class TestCase(unittest.TestCase):
    def testCase1(self):
        result = ExchangeEvenNumberOfCoins([1, 3, 5, 10], 1)
        self.assertEqual(result, 0, "Should be 0")
        
    def testCase2(self):
        result = ExchangeEvenNumberOfCoins([1, 3, 5, 10], 10)
        self.assertEqual(result, 47, "Should be 47")
        
    def testCase3(self):
        result = ExchangeEvenNumberOfCoins([1, 3, 5, 10], 4)
        self.assertEqual(result, 3, "Should be 3")
        
    def testCase4(self):
        result = ExchangeEvenNumberOfCoins([1, 3, 5, 10], 6)
